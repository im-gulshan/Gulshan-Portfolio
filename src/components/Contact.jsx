...
const Contact = () => {
  ...
  const socialLinks = [
    { icon: Linkedin, href: "https://www.linkedin.com/in/gulshan98/", label: "LinkedIn" },
    { icon: Github, href: "https://github.com/im-gulshan?tab=repositories", label: "GitHub" }
  ];
